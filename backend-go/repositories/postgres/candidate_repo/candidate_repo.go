// Package candidate_repo is the pgx-backed candidates store.
package candidate_repo
...
// New constructs a CandidateRepo.
func New(pool *pgxpool.Pool) *CandidateRepo { return &CandidateRepo{pool: pool} }
