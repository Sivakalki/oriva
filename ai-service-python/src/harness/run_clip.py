"""`python -m harness.run_clip <clip.wav> [--config path]`
...
from harness.clip_run import ClipResult, run_clip
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="harness.run_clip")
