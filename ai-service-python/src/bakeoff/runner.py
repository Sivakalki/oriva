"""`python -m bakeoff` — score STT/LLM/TTS combos over a clip set."""
...
from bakeoff.metrics import ComboAggregate, aggregate, unavailable, word_error_rate
from config import LLMConfig, Settings, STTConfig, TTSConfig
from harness.clip_run import run_clip
from pipelines.assembly import build_pipeline
from pipelines.providers.base import ProviderError
